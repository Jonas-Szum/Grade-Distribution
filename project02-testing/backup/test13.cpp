...
Course Decimal3("DEC", "XXXTentacion", 502, 01, "Hummel",
	    /*A-F*/ 12, 24, 54, 43, 34,
...
myDept.Courses.push_back(Decimal3);
myDept.Courses.push_back(Decimal2);
myDept.Courses.push_back(Decimal1);

vector<Course> sizeThree = FindCourses(myDept, "Hum");
REQUIRE(sizeThree.size() == 3);
REQUIRE(sizeThree[0].Instructor == "Hummel");
REQUIRE(sizeThree[1].Instructor == "Hummus");
REQUIRE(sizeThree[2].Instructor == "Hummel");

vector<Course> oneVec = FindCourses(myDept, "Hal9");
REQUIRE(oneVec.size() == 1);
REQUIRE(oneVec[0].Instructor == "Hal9000");

vector<Course> emptyVec = FindCourses(myDept, "Hummel2");
